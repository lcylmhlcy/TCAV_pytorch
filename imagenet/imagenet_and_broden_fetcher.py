...
def fetch_imagenet_class(path, class_name, number_of_images, imagenet_dataframe):
    ...
    print("Fetching imagenet data for " + class_name)
    concept_path = os.path.join(path, class_name)
    tf.io.gfile.makedirs(concept_path)
    print("Saving images at " + concept_path)
...
def download_texture_to_working_folder(broden_path, saving_path, texture_name,
    ...
    print("Using path " + str(broden_textures_path) + " for texture: " +
          str(texture_name))
    ...
    for root, dirs, files in os.walk(broden_textures_path):
        ...
        print("We have " + str(len(texture_files)) +
        ...
        while save_number > 0:
            for file in texture_files:
                ...
                texture_saving_path_file = os.path.join(
                    texture_saving_path, file)
                tf.io.gfile.copy(
